...
export PORTAL_RELEASE_TAG=v0.25.0
...
```bash
sha256sum -c proxmox-vm-portal-offline-0.25.0-amd64.tar.gz.sha256
tar -xzf proxmox-vm-portal-offline-0.25.0-amd64.tar.gz
cd proxmox-vm-portal-offline-0.25.0-amd64
