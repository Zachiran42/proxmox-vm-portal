...
export PORTAL_RELEASE_TAG=v0.21.1
...
```bash
sha256sum -c proxmox-vm-portal-offline-0.21.1-amd64.tar.gz.sha256
tar -xzf proxmox-vm-portal-offline-0.21.1-amd64.tar.gz
cd proxmox-vm-portal-offline-0.21.1-amd64
